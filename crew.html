	 ...
	 viewBox="0 0 432.2 328.3" style="enable-background:new 0 0 432.2 328.3;" xml:space="preserve">
			...
			<div class="site-header-navigation">
				...
				<ul id="siteNavigation" class="site-header-navigation-list collapse d-lg-flex d-md-flex d-sm-none">
					<li><a href="/crew.html" class="active">Our Crew</a></li>
	...
	<div class="welcome-banner welcome-banner-page">
		<div class="container welcome-banner-container">
			<div class="welcome-banner-headline text-center">
				<h1 class="display-3">Our Crew</h1>
			</div>
		</div>
	</div>
			...
			<div class="container">
				...
				<div class="instructor-list">
					<div class="instructor-list-item">
						<div class="instructor-list-image">
							<img src="img/sidney.png" alt="">
						</div>
						<div class="instructor-list-content">
							<h4>Sidney Morgan</h4>
							<hr class="endline endline-blue endline-small endline-left">
							<strong>Photographer, Editor, Founder of <a target="_blank" href="https://editedbyartists.com/" class="text-secondary"><nobr>Edited By Artists</nobr></a></strong>
							<p>
								Sidney is a photographer of 8 years and a serial entrepreneur. What lights her heart on fire is helping businesses succeed and be profitable, all while still maintaining a sense of balance. 
								<br><br>
								With an obsession to succeed, she's built multiple business in her short 24 years. Relocating her photography business (from coast to coast and everywhere in between) six times didn't stop her from having year after year of record-breaking profits. 
								<br><br>
								Featured on: Good Morning America, Artifact Uprising, Travel + Leisure, Junebug Weddings, Style Me Pretty, The Define School, Rover, and more. 
							</p>
						</div>
					</div>
					<div class="instructor-list-item">
						...
						<div class="instructor-list-content">
							<h4>Bethany Micheala Jones</h4>
							<hr class="endline endline-blue endline-small endline-left">
							<strong>Photography, Videographer, Co-founder of <a target="_blank" href="https://sojournersociety.com" class="text-secondary"><nobr>Sojourner Society</nobr></a></strong>
							<p>
					...
					<div class="instructor-list-item">
						...
						<div class="instructor-list-content">
							<h4>Tarun Krishnan</h4>
							<hr class="endline endline-blue endline-small endline-left">
							<strong>Illustrator, Designer, Web Developer, <nobr>Co-Founder</nobr> of <a target="_blank" href="https://sojournersociety.com" class="text-secondary"><nobr>Sojourner Society</nobr></a></strong>
							<p>
