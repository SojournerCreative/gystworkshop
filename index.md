...
<body>
	...
	<div class="welcome-banner">
		<div class="container welcome-banner-container">
			<div class="welcome-banner-action text-center">
				
								
			</div>
			<div class="welcome-banner-headline text-lg-right text-md-right text-center">
				<h1 class="display-1">Not Your Average F**king Workshop</h1>
				<h2>Feb 7-8th 2019</h2>
			</div>
		</div>
	</div>
	<div class="bg-secondary text-center" style="padding:20px;">
							<div class="container">
								<div class="row align-items-center justify-content-center">
									<div class="col-md-12">
										<h5 class="text-light h2">Subscribe to Our Newsletter</h5>
									</div>
									<div class="col-md-6">
										<p class="text-light lead">Stay updated with announcements, press, new conference details, and more!
										</p>
										<a href="http://eepurl.com/dPq7uv" target="_blank" class="btn btn-primary">Subscribe</a>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 text-light">
										<small>We hate spam as much as you do! 😊 <br> You'll just receive messages when they are absolutely necessary.</small>
									</div>
								</div>
							</div>
						</div>
	<main class="page-content page-content-home">
			<div class="container text-center">
				<h1>Get Accountable. Define Success. Step Up Your Game</h1>
			</div>
			<div class="container">
				<ul class="zigzag-list">
					<li>Do you consider yourself an artist?</li>
					<li>Why did you become a photographer?</li>
					<li>Do you compare your work to other photographers?</li>
					<!-- <li>Do you overthink everything and find it hard to take your business to the next level? </li> -->
				</ul>
				...
				<div class="row align-items-center justify-content-center text-center">
					<div class="col-md-8">
						<p>
							Wedding photography is a weird world where it seems everyone is putting on a show, so we created a workshop that cuts the bullsh*t. We will discuss the psychology behind being an artist and what it means to go from considering yourself a person with a camera to an artist with a voice. Photography can be so beautiful and empowering, but sometimes we all get lost in the sea of indecision and self-doubt. There is freedom in knowing that wedding photography isn’t about you and that you don’t save lives. And by not caring about what others think, you are able to give your clients a better experience and product. There’s nothing to prove, there are only stories to tell. We truly believe that nothing is holding you back more than yourself.
						</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<br>
			<h2 class="h1 text-center">What We Give You</h1>
				<br>
			...
			<div class="workshop-actions text-center">
				<br><br>
				<a href="/workshop" target="_blank" class="btn btn-lg btn-secondary">Learn more</a><br>
				<a href="/workshop/schedule" class="btn btn-primary btn-sm">View The Workshop Schedule</a>
		...
		<hr class="endline endline-yellow">
		<div class="container">
			<div class="instructors-block">
				<div class="instructors-block-profiles">
										<div class="bethany person-1 instructors-block-image">
						<span>sidney</span>
						<img src="img/sidney.png" alt="">
					</div>
					<div class="sidney person-2 instructors-block-image">
						<span>bethany</span>
						<img src="img/bethany.png" alt="">
					</div>
				</div>
				<div class="instructors-block-content text-lg-left text-center">
					<h2 class="h1">Meet Your Instructors</h2>
					<p>
						2019 holds so much potential and we want to help you get your sh*t together. We want to equip you with actionable items, so you can drop the excuses in the new year. We’re giving you the tools and strategy to be take your business to the next level and we promise to hold you accountable to getting your sh*t together. 
						<br><br>
						Bethany and Sidney have been wedding photographers for over ten years. We’ve been collectively featured on 100 Layer Cake, Brides, Artifact Uprising, Brooklyn Bride, Carats & Cake, Design Aglow, Junebug Weddings, Madera Albums, Maharani Weddings, Style Me Pretty, The City Sage, The Define School, and Travel + Leisure.
					</p>
					<h4 class="display-4 text-primary">
						And Most Importantly <br>
						<small class="text-secondary">We Pay Rent on time every month on NYC!</small>
					</h4>
				</div>
			</div>
		</div>
		<hr class="endline endline-blue">
		<div class="container audience-call">
			<h2 class="display-4 text-center">WHO IS THIS BADASS WORKSHOP FOR? </h2>
			<div class="audience-call-container">
				<div class="audience-call-image">
					<img src="img/audience-img.png" alt="">
				</div>
				<div class="audience-call-demog">
					<h4>Anyone who is looking to step up their game!</h4>
					<span class="audience-call-ampersand-divider">&amp;</span>
					<h4>Take Their Business To The Next Level!</h4>
				</div>
			</div>
		</div>
